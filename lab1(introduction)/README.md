...
4. сливаем нашу ветку с основной веткой main. Это можно сделать тоже по-разному:
    -  прямо на сайте github в своём репозитории. Вам сайт предложит создать pull request и затем слить ветки(рекомендую делать так).
    ...
    git branch -d "название ветки" # удаляем нашу ветку
    ```